      ...
      <div className="container mx-auto max-w-6xl">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <motion.div
            ...
            className="space-y-6"
          >
            <h2 className="text-4xl md:text-5xl font-bold">About TechVerse</h2>
            <div className="space-y-4 text-muted-foreground leading-relaxed">
              <p>
                TechVerse is more than just a hackathon—it's a movement to empower developers across India to build
              ...
              <p>
                Whether you're a seasoned developer or just starting your journey, TechVerse welcomes you to be part of
